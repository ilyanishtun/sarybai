...
<?php
	...
	$address = "inishtun@yandex.ru";//адрес куда будет отсылаться сообщение для администратора
	...
	if ($send) //проверяем, отправилось ли сообщение
		echo "Спасибо, мы записали ваш email.";
	else 
		echo "Упс, не получилось! Возможно, проблемы на сервере";
